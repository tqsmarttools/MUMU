...
set "SCRIPT=D:\MUMU\scripts\TT-G1.3.py"
set "SERIAL=127.0.0.1:16448"
set "LOG=D:\MUMU\scripts\logs\tt_g1_3_run.log"
set "PYTHONIOENCODING=utf-8"
set "PYTHONUTF8=1"

if not exist "D:\MUMU\scripts\logs" mkdir "D:\MUMU\scripts\logs"
echo ==== START %DATE% %TIME% ====>> "%LOG%"
"%PY%" "%SCRIPT%" --serial %SERIAL% --keyword "bay xay dung" --delay-multiplier 1.35 >> "%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
